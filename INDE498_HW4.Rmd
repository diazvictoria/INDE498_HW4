...
nonzero coefficients and plot the results. 
```{r} 
require(glmnet)
...
We see that the cross-validation showed that the best choice for lambda is 0.3964124. This choice will give us a MSE of 0.1620063
```{r}
cv.fit$lambda.min
